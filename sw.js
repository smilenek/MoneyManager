const CACHE = 'capmoney-shell-v5';
const FILES = ['./', './index.html', './style.css', './pro.css', './ui.css', './profile.js', './app.js', './finance.js', './media.js', './pro.js', './sharing.js', './manifest.json', './icons/icon.svg', './icons/icon-192.png', './icons/icon-512.png'];
